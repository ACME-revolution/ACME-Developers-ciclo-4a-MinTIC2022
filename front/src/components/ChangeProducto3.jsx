            ...
            <section className='agregar' id='agregar'>
                <form action="">
                    <div className='inputBox'>
                        ...
                        <input className='cajon' type='text' placeholder="Iman"></input>
                        <span className='etiqueta'>Descripción:</span>
                        <input className='cajon1' type='text' placeholder="Iman"></input>
...
export default ChangeProducto3